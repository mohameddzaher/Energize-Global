          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 pt-3">
              <button
                ...
                className="cursor-pointer px-5 py-2 bg-gradient-to-r from-red-900 to-gray-800 text-white text-sm font-medium rounded-lg hover:shadow-lg hover:shadow-red-500/20 transition-all duration-300 flex items-center justify-center gap-1.5 group"
              >
                <span>{cta1}</span>
              ...
              <button
                ...
                className="cursor-pointer px-5 py-2 bg-white/10 backdrop-blur-sm text-white text-sm font-medium rounded-lg border border-white/30 hover:bg-white/15 hover:border-white/40 transition-all duration-300 flex items-center justify-center gap-1.5 group"
              >
                <span>{cta2}</span>
