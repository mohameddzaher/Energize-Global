    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl md:text-2xl font-bold text-gray-950 mb-4 tracking-tight">
        ...
        <div className="grid lg:grid-cols-2 gap-6 items-center">
          ...
          <div className="space-y-5">
            {/* Vision Card */}
            <div className="group relative p-5 bg-gradient-to-br from-gray-900/90 to-black/50 rounded-lg border border-gray-800/40 hover:border-red-500/50 transition-all duration-300">
          ...
          {/* Our Differentiators */}
          <div className="relative">
            <div className="p-5 bg-gradient-to-br from-gray-900/90 to-black/50 rounded-lg border border-gray-800/40 group transition-all duration-300">
              ...
              <div className="relative">
                ...
                <p className="text-gray-300 leading-relaxed text-xs mb-5 tracking-normal">
                  Distinctive advantages that make Energize Business Group your
                  trusted partner
                </p>
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gradient-to-br from-gray-900/40 to-black/30 rounded-md border border-gray-800/30 hover:border-red-500/30 transition-all duration-300">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-gray-400 leading-relaxed">
                        Our portfolio companies work synergistically to deliver
                        seamless, coordinated results.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gradient-to-br from-gray-900/40 to-black/30 rounded-md border border-gray-800/30 hover:border-red-500/30 transition-all duration-300">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-gray-400 leading-relaxed">
                        24+ years of in-depth knowledge of Saudi and MENA market
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gradient-to-br from-gray-900/40 to-black/30 rounded-md border border-gray-800/30 hover:border-red-500/30 transition-all duration-300">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-gray-400 leading-relaxed">
                        Continuously adapting and innovating to stay ahead of
                ...
                <div className="pt-3 border-t border-gray-800/30">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M5 2a1 1 0 011 1v1h1a1 1 0 010 2H6v1a1 1 0 01-2 0V6H3a1 1 0 010-2h1V3a1 1 0 011-1zm0 10a1 1 0 011 1v1h1a1 1 0 110 2H6v1a1 1 0 11-2 0v-1H3a1 1 0 110-2h1v-1a1 1 0 011-1zM12 2a1 1 0 01.707.293l4 4a1 1 0 01-1.414 1.414L14 5.414V11a1 1 0 11-2 0V5.414l-1.293 1.293a1 1 0 01-1.414-1.414l4-4A1 1 0 0112 2z"
                        clipRule="evenodd"
                      />
                    </svg>
                    <div className="text-[10px] text-white">
                      ...
                      • Pioneering business excellence for over two decades
                    </div>
                  </div>
                </div>
              </div>
