...
export const languages: Record<Lang, any> = {
  en: {
    ...
    contact: {
      ...
      subtitle: "Contact us today to discuss how we can help you achieve your business goals and reach new horizons of success.",
    ...
    footer: {
      ...
      subscribeText: "Be the first to know about our latest news and special offers",
